...
![~2D\ kartesisches\ Koordinatensystem~ ~(@bolino)~](https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/CartesianPlane.svg/3840px-CartesianPlane.svg.png)


![~3D\ kartesisches\ Koordinatensystem\ (@sakurambo)~](https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/3D_coordinate_system.svg/1280px-3D_coordinate_system.svg.png){width="70%" height="70%"}
