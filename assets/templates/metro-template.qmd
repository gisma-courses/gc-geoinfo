...
## Media Backgrounds {background="#43464B" background-image="../images/metropolis/milky-way.jpeg"}
...
![](../images/metropolis/kitten-400-350.jpeg){.absolute top="170" left="30" width="400" height="400"}

![](../images/metropolis/kitten-450-250.jpeg){.absolute .fragment top="150" right="80" width="450"}

![](../images/metropolis/kitten-300-200.jpeg){.absolute .fragment bottom="110" right="130" width="300"}
...
## Tabsets {.smaller .scrollable transition="convex"}
...
::: {layout-ncol="2"}
![](../images/metropolis/moon.png)

![](../images/metropolis/sky.png)
:::
...
::: {layout="[1, 20]"}
![](../images/metropolis/presentation-menu.png){width="41"}
...
::: {layout="[1, 20]"}
![](../images/metropolis/presentation-chalkboard.png){width="41"}

Use the chalkboard button at the bottom left of the slide to toggle the chalkboard.
:::

::: {layout="[1, 20]"}
![](../images/metropolis/presentation-notes-canvas.png){width="41"}
...
![](../images/metropolis/overview-mode.png){.border}
...
![](../images/metropolis/speaker-view.png){fig-align="center" style="border: 3px solid #dee2e6;" width="780"}
...
::: columns
::: {.column width="46%"}
![](../images/metropolis/jupyter-edit.png){.border .border-thick}
:::

::: {.column width="46%"}
![](../images/metropolis/jupyter-preview.png){.border .border-thick}
:::
:::
...
![](../images/metropolis/rstudio.png){.border width="900"}
