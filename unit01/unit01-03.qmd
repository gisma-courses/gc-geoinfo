...
![Abbildung 01-03: Blick auf die Fränkische Schweiz von Westen. In der Bildmitte ist der Zeugenberg Walberla zu sehen (Quelle:  @arnold)](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Fr%C3%A4nkische-Schweiz-westliche-Kante-16-05-2005.jpeg/1280px-Fr%C3%A4nkische-Schweiz-westliche-Kante-16-05-2005.jpeg)


Beginnen wir mit einem geographischen Raumbegriff, der uns aus dem Alltagswissen vertraut ist. So kennen viele die Region [*Fränkische Schweiz*](https://de.wikipedia.org/wiki/Fr%C3%A4nkische_Schweiz). Mit solchen *Raumentitäten* verbinden wir eine mehr oder weniger diffuse, aber abgegrenzte räumliche Ausdehnung (Region) oder die Vorstellung einer Landschaft (vgl. Abb. 01-03). Häufig werden solchen als Einheit wahrgenommenen Räumen auch Attribute wie kulinarische, kulturelle oder freizeitorientierte Aspekte zugeordnet. So ist die Fränkische Schweiz nicht nur für ihre Weine und Biere bekannt, sondern beispielsweise auch für ihre Osterbrunnen (vgl. Abb. 01-04) oder ihr touristisches Potenzial.
...
![Abbildung 01-06: Karte der Fränkischen Schweiz (Quelle: @mikmaq](https://upload.wikimedia.org/wikipedia/commons/2/28/Fraenkische_Schweiz.png){width="75%"}
